...
class Baseline(pl.LightningModule):
    def __init__(self, config):
        ...
        self.model = EfficientNet3D.from_name("efficientnet-b0", override_params={'num_classes': 1, 'image_size':128}, in_channels=3)
...
if __name__ == '__main__':
    ...
    checkpoint_callback = ModelCheckpoint(dirpath="/raid/home/automathon_2024/account24/erwin/automathon-2024/checkpoints/CNNErwin/", every_n_train_steps=2, save_top_k=1, save_last=True,
